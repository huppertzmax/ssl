...
save_npz(f"./generated/sparse_matrix_{n_formatted}/block/matrix.npz", sparse_matrix)
...
save_npz(f"./generated/sparse_matrix_{n_formatted}/block/diagonal_inv_sqrt_matrix.npz", diagonal_inv_sqrt_matrix)
...
save_npz(f"./generated/sparse_matrix_{n_formatted}/block/normalized_matrix.npz", normalized_matrix)

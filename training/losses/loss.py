...
def loss(out_1, out_2, temperature=0.1, gamma=2.0, gamma_lambd=1.0, distance_p=2.0, loss_type="nt_xent", acos_order=0, feat_dim=32, heat_kernel=None, penalty_constrained=False):
    if acos_order > 0:

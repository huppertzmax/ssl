...
from training.linear_evaluation import linear_evaluation
...
if __name__ == "__main__":
    ...
    # data
    parser.add_argument("--dataset", type=str, help="cifar10, mnist", default="cifar10")
    ...
    parser.add_argument("--in_features", type=int, default=512, help="2048 for resnet50 and 512 for resnet18") 
    ...
    log_msg(f"Finetuning {args.arch} with checkpoint {args.ckpt_path} on {args.dataset} starting ...")
    linear_evaluation({}, args)
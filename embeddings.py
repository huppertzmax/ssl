...
def calculate_chunk_embedding(num_augmentations, num_samples_per_class, ckpt_path, data_path, storage_path, num_chunks):
...
def calculate_embedding(num_augmentations, num_samples_per_class, ckpt_path, data_path, storage_path):
    backbone = load_backbone(ckpt_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_path", type=str, default="results/serene-leaf-105/last.ckpt")
    parser.add_argument("--ckpt_name", type=str, default="serene-leaf-105")
    ...
    if args.chunked_data: 
        ...
        calculate_chunk_embedding(args.num_augmentations, args.num_samples_per_class, args.ckpt_path, args.data_path, args.storage_path, args.num_chunks)
    else: 
        args.data_path = f"{args.data_path}mnist_train_subset_{args.num_samples_per_class}_per_class_aug_{args.num_augmentations}.pt"
        calculate_embedding(args.num_augmentations, args.num_samples_per_class, args.ckpt_path, args.data_path, args.storage_path)
